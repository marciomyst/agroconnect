...
5. **Nenhum código de infra** (EF, Wolverine, Dapper) é permitido em `Agronomia.Domain.Common`.
...
```text
You are implementing the F0.1 — Shared Kernel for the Agronomia backend (.NET 10).
